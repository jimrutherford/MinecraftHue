...
- (void)notAuthenticated {
    ...
    //[self.contentViewController popToRootViewControllerAnimated:YES];
...
- (void)searchForBridgeLocal {
    ...
    [bridgeSearch startSearchWithCompletionHandler:^(NSDictionary *bridgesFound) {
        ...
        if (bridgesFound.count > 0) {
            ...
            [self.contentViewController presentViewController:navController animated:YES completion:nil];
        }
        else {
            /***************************************************
...
- (void)doAuthentication {
    ...
    [self.contentViewController presentViewController:self.pushLinkViewController animated:YES completion:^{
        /***************************************************
